...
Function InstallMiktex {
  ...
  $MIKTEX_MIRROR = "http://mirror.koddos.net/CTAN/systems/win32/miktex/setup/windows-x64/" + $miktex_file
  ...
  mpm --admin --set-repository=http://mirror.koddos.net/CTAN/systems/win32/miktex/tm/packages/
