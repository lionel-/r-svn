...
Function InstallMiktex {
  ...
  $MIKTEX_MIRROR = "http://ctan.math.utah.edu/ctan/tex-archive/systems/win32/miktex/setup/windows-x64/" + $miktex_file
  ...
  mpm --admin --set-repository=http://ctan.math.utah.edu/ctan/tex-archive/systems/win32/miktex/tm/packages/
  ...
  type C:\ProgramData\MiKTeX\miktex\log\mpmcli_admin.log
